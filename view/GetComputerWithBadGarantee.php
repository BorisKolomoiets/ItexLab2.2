...
$date = $_GET['date'];
$strtotime = new MongoDB\BSON\UTCDateTime(strtotime($date) * 1000);
$filter = ["guarantee" => ['$lt' => $strtotime]];
...
echo "<p>Computers with bad guarantee up to : </p><h2 id = 'header'>" . $date . "</h2>";
